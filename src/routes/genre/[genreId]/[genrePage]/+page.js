...
export async function load({ fetch, params }) {
  ...
  try {
    ...
    const responseData = await fetch(`https://api.themoviedb.org/3/discover/movie?api_key=${PUBLIC_API_kEY}&language=en-US&sort_by=popularity.desc&include_adult=false&with_genres=${genre.id}&page=${genrePage}`)
